              ...
              <ul className="haut-touche">
                ...
                <li>
                  <Link to="/admin/scolarites">
                    <i className="bi bi-gear"></i> Scolarité
                  </Link>
                </li>
                <li>
                ...
                {/* <li>
                  <Link to="/admin/presences">
                    <i className="bi bi-gear"></i> Présence
                  </Link>
                </li> */}
                {/* <li>
                ...
                <li>
                  <Link to="/admin/matieres">
                    <i className="bi bi-gear"></i> Matières
                  </Link>
                </li>
                <li>
      ...
      <div className="all-barre-horizontal">
        <div className="corps-horizontal">
          <div className="title-dash">
            <h1>Secretariat de {user?.school} </h1>
          </div>
          <div id="profil">
            <div id="conprofil">
              {/* <img src={`http://localhost:3000/uploads/livreurs/${user.photo}`} alt="Photo user" /> */}
