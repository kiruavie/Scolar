        ...
        <div className="all-eleves">
          <div className="gauche">
            ...
            <form onSubmit={handleSubmit} className="form-container" encType="multipart/form-data">
              ...
              <div className="form-group">
                <label>Photo</label>
                <input type="file" name="photoProfil" onChange={handleChange} />
              </div>
...
/>
                    ...
                    <td>
                      <button className="btn btn-warning btn-sm" onClick={() => handleEdit(e)}>Modifier</button>
                      {/* <button className="btn btn-danger btn-sm ml-2" onClick={() => handleDelete(e.id)}>Supprimer</button> */}
                    </td>
                  </tr>
                ))}
              </tbody>
